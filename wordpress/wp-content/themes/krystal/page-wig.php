...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		<div class="page-wig-wrapper">
			<div class="page-wig-con">
				<?php
				$temp = $wp_query;
				$wp_query = null;
				...
				<?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
					<div class="page-fonance-content">
						...
						<div class="wig-graph-wrapper">
							...
							<div class="graph-green wig-graph-early-box wig-graph-max">
								<div class="wig-graph-item">
									<div class="graph-green wig-graph-early wig-graoh-p" style="width: <? echo round($wigepc); ?>%;"><span><? echo round($wigepc); ?>%</span>
									</div>	
								</div>
							</div>
							...
							<?php if (empty($wig8)) {
								...
								<div class="graph-green wig-graph-early-box wig-graph-max">
									<div class="wig-graph-item">
										<div class="graph-green wig-graph-early wig-graoh-p" style="width: <? echo round($wigepc2); ?>%;"><span><? echo round($wigepc2); ?>%</span>
										</div>	
									</div>
								</div>
								<?php } ;?>
								...
								<?php if (empty($wig11)) {
									...
									<div class="graph-green wig-graph-early-box wig-graph-max">
										<div class="wig-graph-item">
											<div class="graph-green wig-graph-early wig-graoh-p" style="width: <? echo round($wigepc3); ?>%;"><span><? echo round($wigepc3); ?>%</span>
											</div>	
										</div>
									</div>
									<?php } ;?>
